...
class LLMWorkerConfig:
    ...
    fast_validation_window_days: int = 30
    fast_validation_window_count: int = 3
    fast_validation_refresh_interval_seconds: int = 21600
    fast_validation_campaigns_root: str = "validation_campaigns"
    fast_validation_active_campaign_path: str = "validation_active_campaign.txt"
    rollout_validation_window_days: int = 30
    rollout_validation_window_count: int = 12
    rollout_validation_refresh_interval_seconds: int = 86400
    rollout_validation_campaigns_root: str = "rollout_validation_campaigns"
    rollout_validation_active_campaign_path: str = "rollout_validation_active_campaign.txt"
    rollout_candidate_shortlist_size: int = 3

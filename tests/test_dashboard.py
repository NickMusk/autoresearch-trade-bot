...
class DashboardSnapshotTests(unittest.TestCase):
    def test_snapshot_exposes_metrics_and_blockers(self) -> None:
        ...
        self.assertEqual(snapshot.phase, "Research kernel with dashboard")
        self.assertFalse(snapshot.deployment_ready)
        self.assertTrue(snapshot.accepted_for_paper)
        self.assertIn("Historical Binance ingestion is not implemented yet.", snapshot.deployment_blockers)
